...
class Sepuluhjuta extends StatelessWidget {
  Sepuluhjuta({@required this.h_tujuan, @required this.h_nominal});
  ...
  List<ykdata> data = [
    ...
    ykdata("OCBC", "assets/icon/ocbc.png", 2.85),
    ykdata("Permata", "assets/icon/permata.png", 2.75),
    ykdata("Panin", "assets/icon/panin.png", 2.25),
  ];
